...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h2 class="mb-4">Cadastro de Dívida</h2>
            <form action="adicionar-divida" method="post">
                ...
                <button type="submit" class="btn btn-primary" style="margin-top: 24px;" >Cadastrar Dívida</button>
            </form>
        </div>
    </div>
</div>
